...
class StandardAbility:
    ...
    def fixed(self):
        ...
        if self.style == 'magic':
            fixed = math.floor(math.floor(self.ability_dmg * self.min_dmg) * (1 + self.magic_prayer))
        elif self.style == 'range':
            fixed = math.floor(math.floor(self.ability_dmg * self.min_dmg) * (1 + self.range_prayer))
        elif self.style == 'melee':
            fixed = math.floor(math.floor(self.ability_dmg * self.min_dmg) * (1 + self.melee_prayer))
        else:
            pass
        return fixed
    ...
    def variable(self):
        if self.style == 'magic':
            variable = math.floor(math.floor(self.ability_dmg * (self.max_dmg - self.min_dmg)) * (1 + self.magic_prayer))
        elif self.style == 'range':
            variable = math.floor(math.floor(self.ability_dmg * (self.max_dmg - self.min_dmg)) * (1 + self.range_prayer))
        elif self.style == 'melee':
            variable = math.floor(math.floor(self.ability_dmg * (self.max_dmg - self.min_dmg)) * (1 + self.melee_prayer))
        else:
            pass
        return variable
    ...
    def precise(self):
        ...
        precise = math.floor(0.015 * (fixed + variable) * rank)
